...
item_cosine=pickle.load(open('C://Users//DELL//Project//item_cosine.pkl','rb'))
item_matrix=pickle.load(open('C://Users//DELL//Project//item_matrix.pkl','rb'))
user_vecs=pickle.load(open('C://Users//DELL//Project//user_vecs.pkl','rb'))
item_vecs=pickle.load(open('C://Users//DELL//Project//item_vecs.pkl','rb'))
cust_dict=pickle.load(open('C://Users//DELL//Project//cust_dict.pkl','rb'))
itemindex_dict=pickle.load(open('C://Users//DELL//Project//item_dict.pkl','rb'))
...
@appnew.route('/submit',methods=['POST','GET'])
def submit():
